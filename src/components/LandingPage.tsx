                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center border rounded-md overflow-hidden">
                            <button
                                ...
                                className={`px-3 py-1 text-xs font-bold cursor-pointer ${language === 'fr' ? 'bg-primary text-primary-foreground' : 'hover:bg-muted'}`}
                            >
                                {t('nav.fr')}
                            </button>
                            <button
                                onClick={() => setLanguage('en')}
                                className={`px-3 py-1 text-xs font-bold cursor-pointer ${language === 'en' ? 'bg-primary text-primary-foreground' : 'hover:bg-muted'}`}
                            >
                                {t('nav.en')}
                            </button>
                        </div>
